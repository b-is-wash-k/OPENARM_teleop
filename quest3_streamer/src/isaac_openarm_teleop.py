...
# #     # Robot workspace centscaleer (where hands map to when at VR origin)
...
# #     # "smoothing": 0.5,  # Smoothing factor (0=no smoothing, 0.9=very smooth)
# #     "smoothing": 0.3,  # Smoothing factor (0=no smoothing, 0.9=very smooth)
...
# #     # Move scene objects at runtime without editing the USD file.
# #     # Negative X moves the table/box/drill back toward the OpenArm base.
...
# #         self.button_b_pressed = False  # Right controller B button
# #         self.button_x_pressed = False  # Left controller X button
# #         self.button_y_pressed = False  # Left controller Y button
...
# #         # Button handling: buttons[0] is A/X, buttons[1] is B/Y
...
# #         # Print FK at zero config so we know actual reachable workspace
# #         try:
...
# #             # Auto-set workspace center from FK (midpoint between arms, slight forward offset)
...
#     "position_tolerance": 0.05,
#     "orientation_tolerance": 0.5,  # Radians; larger is more forgiving for wrist rotation
#     # Move scene objects at runtime without editing the USD file.
#     # Negative X moves the table/box/drill back toward the OpenArm base.
...
#     """Blend quaternions in wxyz format while avoiding sign-flip jumps."""
...
#         orientation_tolerance = CONFIG.get("orientation_tolerance", 0.5)
#         left_orientation_target = teleop_node.left_arm.smoothed_rot if use_orientation_ik else None
#         right_orientation_target = teleop_node.right_arm.smoothed_rot if use_orientation_ik else None
...
#             left_actions, left_success = left_ik_solver.compute_inverse_kinematics(
#                 target_position=teleop_node.left_arm.smoothed_pos,
#                 target_orientation=left_orientation_target,
#                 frame_name="openarm_left_hand",
#                 warm_start=warm_start,
...
#             right_actions, right_success = right_ik_solver.compute_inverse_kinematics(
#                 target_position=teleop_node.right_arm.smoothed_pos,
#                 target_orientation=right_orientation_target,
#                 frame_name="openarm_right_hand",
#                 warm_start=warm_start,
#                 position_tolerance=position_tolerance,
#                 orientation_tolerance=orientation_tolerance,
