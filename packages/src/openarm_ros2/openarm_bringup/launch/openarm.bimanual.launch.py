...
def generate_robot_description(context: LaunchContext, description_package, description_file,
    ...
    # Define control gains for all joints - pass as individual xacro parameters
    # Joints 1-2: DM8009, Joints 3-4: DM4340, Joints 5-7: DM4310
    ...
    robot_description = xacro.process_file(
        ...
        mappings={
            ...
            # NOTE: These kp/kd mappings here are IGNORED. The xacro at
            # openarm_description/urdf/robot/v10.urdf.xacro loads gains from
            # openarm_description/config/arm/v10/control_gains.yaml — edit
            # THAT yaml to actually change arm stiffness. Kept here only
