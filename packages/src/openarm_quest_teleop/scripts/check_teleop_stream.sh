...
#   - The actual quest_bridge.py currently serves plain ws://. If this checker
#     works but quest_bridge does not connect from the HTTPS page, the next fix
#     is likely to add TLS/WSS support to quest_bridge.py or use a local reverse
#     proxy.
